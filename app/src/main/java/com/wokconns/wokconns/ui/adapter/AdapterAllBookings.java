        ...
        if (holderMain instanceof MyViewHolder) {
            ...
            if (artistBookingsList.get(position).getBooking_type().equalsIgnoreCase("0") || artistBookingsList.get(position).getBooking_type().equalsIgnoreCase("3")) {
                ...
                if (artistBookingsList.get(position).getBooking_flag().equalsIgnoreCase("0")) {
                    ...
                    holder.binding.tvTxt.setText(context.getResources().getString(R.string.booking) + " "+context.getResources().getString(R.string.pending)+"["+artistBookingsList.get(position).getId()+"]");
                    ...
                    holder.binding.tvTxt.setText(context.getResources().getString(R.string.booking) +" "+ context.getResources().getString(R.string.acc)+"["+artistBookingsList.get(position).getId()+"]");
                    ...
                    holder.binding.tvTxt.setText(context.getResources().getString(R.string.booking) +" "+ context.getResources().getString(R.string.rejected1)+"["+artistBookingsList.get(position).getId()+"]");
                    ...
                    holder.binding.tvTxt.setText(context.getResources().getString(R.string.booking) + " "+context.getResources().getString(R.string.completed1)+"["+artistBookingsList.get(position).getId()+"]");
                }
